...
void main(void) {
    ...
    TskCreate(VTask_Probe, VTASK_PROBE);            // Voltage monitor and PWM duty ratio calibrate
    TskCreate(VTask_Activate, VTASK_ACTIVATE);      // Activate the voltage monitor module
